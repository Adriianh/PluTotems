...
import com.github.adriianh.common.config.ConfigListener.isListeningFile
import com.github.adriianh.common.config.ConfigListener.removeFileListener
import com.github.adriianh.common.config.util.getTotemData
...
object ConfigLoader {
    ...
    private fun clearFiles() {
        files.forEach {
            if (isListeningFile(it)) {
                removeFileListener(it)
            }
        }
